import numpy as np
import torch
from MEigenCAM.yolov8_cam.base_cam import BaseCAM
from MEigenCAM.yolov8_cam.utils.find_layers import find_layer_predicate_recursive
from MEigenCAM.yolov8_cam.utils.svd_on_activations import get_2d_projection
from MEigenCAM.yolov8_cam.utils.image import scale_accross_batch_and_channels, scale_cam_image
